function cellular_automata_map(_width, _height, _spawn_chances, _create_limit, _destroy_limit) constructor {
    ...
    for (var col = 0; col < width; col++) {
        ...
        for (var row = 0; row < height; row++) {
            ...
            } else if (rand < _spawn_chances[TileType.GRASS]+ _spawn_chances[TileType.WATER]+ _spawn_chances[TileType.SAND]){
                map[col][row] = TileType.SAND;
            } else {
				map[col][row] = TileType.FOREST;	
			}
        }
    }
        ...
        repeat (_num) {
            ...
            for (var col = 0; col < width; col++) {
                ...
                for (var row = 0; row < height; row++) {
                    ...
                    var neighbor_counts = array_create(4, 0);
                    ...
                    if (neighbor_counts[TileType.GRASS] > create_limit) {
					...
					} else if (neighbor_counts[TileType.FOREST] > create_limit) {
						new_type = TileType.FOREST;
					} else if (neighbor_counts[current_type] < destroy_limit) {
						
						if (current_type = TileType.WATER){
							if (max(neighbor_counts[TileType.GRASS], neighbor_counts[TileType.FOREST], neighbor_counts[TileType.SAND]) == neighbor_counts[TileType.GRASS]){
								new_type = TileType.GRASS;	
							} else if (max(neighbor_counts[TileType.GRASS], neighbor_counts[TileType.FOREST], neighbor_counts[TileType.SAND]) == neighbor_counts[TileType.FOREST]) {
								new_type = TileType.FOREST;
							} else {
								new_type = TileType.SAND;	
							}
						...
						} if (current_type = TileType.GRASS) {
							if (max(neighbor_counts[TileType.WATER], neighbor_counts[TileType.FOREST], neighbor_counts[TileType.SAND]) == neighbor_counts[TileType.FOREST]){
								new_type = TileType.FOREST;	
							} else if (max(neighbor_counts[TileType.WATER], neighbor_counts[TileType.FOREST], neighbor_counts[TileType.SAND]) == neighbor_counts[TileType.SAND]) {
								new_type = TileType.SAND;
							} else {
								new_type = TileType.WATER;	
							}
						...
						} if (current_type = TileType.SAND){
							if (max(neighbor_counts[TileType.GRASS], neighbor_counts[TileType.FOREST], neighbor_counts[TileType.WATER]) == neighbor_counts[TileType.GRASS]){
								new_type = TileType.GRASS;	
							} else if (max(neighbor_counts[TileType.GRASS], neighbor_counts[TileType.FOREST], neighbor_counts[TileType.WATER]) == neighbor_counts[TileType.FOREST]) {
								new_type = TileType.FOREST;
							} else {
								new_type = TileType.WATER;	
							}
						...
						} if (current_type = TileType.FOREST){
							if (max(neighbor_counts[TileType.GRASS], neighbor_counts[TileType.SAND], neighbor_counts[TileType.WATER]) == neighbor_counts[TileType.GRASS]){
								new_type = TileType.GRASS;	
							} else if (max(neighbor_counts[TileType.GRASS], neighbor_counts[TileType.SAND], neighbor_counts[TileType.WATER]) == neighbor_counts[TileType.SAND]) {
								new_type = TileType.SAND;
							} else {
								new_type = TileType.WATER;	
							}
