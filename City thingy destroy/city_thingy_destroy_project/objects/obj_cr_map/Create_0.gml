...
var spawn_chances = array_create(3, 0);
spawn_chances[TileType.GRASS] = 0.30;
spawn_chances[TileType.WATER] = 0.32;
spawn_chances[TileType.SAND] = 0.38;

// Create the map
my_map = new cellular_automata_map(50, 50, spawn_chances, 4, 2);
